    ...
    <main class="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        {:else}
            ...
            <div class="p-12 rounded-3xl bg-white dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 shadow-2xs text-center max-w-xl mx-auto space-y-4">
                ...
                <h2 class="text-lg font-bold text-slate-900 dark:text-white">Inspect any URL</h2>
                <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    Type a URL in the inspection bar above to check whether it's indexed, analyze crawl headers, test mobile friendliness, or dispatch immediate crawler re-indexing.
                </p>
            </div>
        {/if}
    </main>
